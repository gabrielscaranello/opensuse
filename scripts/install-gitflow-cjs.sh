...
DOWNLOAD_URL="https://raw.githubusercontent.com/CJ-Systems/gitflow-cjs/refs/heads/legacy-develop/contrib/gitflow-installer.sh"
TMP_DIR="$PWD/gitflow"
...
echo "Installing..."
sudo bash $OUTPUT_FILE install version v2.2.1
